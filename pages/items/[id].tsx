    ...
    <div className="px-4 py-10">
      <div>
        ...
        <div className="mt-10">
          ...
          <div className="flex items-center justify-between space-x-3">
            ...
            <button className="flex items-center justify-center rounded-md p-3 text-gray-400 hover:text-gray-600 hover:outline hover:outline-blue-300">
              <svg
                className="h-6 w-6 "
      ...
      <div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          {[1, 2, 3, 4, 5, 6].map((_, i) => (
            <div key={i}>
              <div className="mb-4 h-56 w-full bg-blue-300" />
