...
const Home: NextPage = () => {
  return (
    <div className="flex-col space-y-5 bg-slate-400 py-20 px-10">
      <div className=" rounded-3xl bg-white p-10 shadow-xl">
        ...
        <button
          className="mt-5 w-3/4 rounded-xl bg-blue-500 p-3 text-center text-white
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex items-center justify-between">
            <div className="space-x-2">
              <button className="h-5 w-5 rounded-full bg-indigo-500 ring-indigo-500 ring-offset-2 focus:ring-2" />
              <button className="h-5 w-5 rounded-full bg-teal-500 ring-teal-500 ring-offset-2 focus:ring-2" />
              <button className="h-5 w-5 rounded-full bg-yellow-500 ring-yellow-500 ring-offset-2 focus:ring-2" />
            </div>
